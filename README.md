...
1. Killer Title Include all relevant buzzwords (e.g., “Funnel Analysis,” “Exploratory Data Analysis”) and the industry (e.g., “Fintech,” “Healthcare”) to attract the right hiring managers.
2. Executive Summary Summarize the entire project, the business problem, the solution, the number impact, and important next steps. This may be the only part read.
3. Business Problem Clearly outline why you did the project and the problem you are trying to solve. This shows you are thinking about the business impact.
